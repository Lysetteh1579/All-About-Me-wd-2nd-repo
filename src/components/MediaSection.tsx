...
import { DEFAULT_MEDIA } from '../data/profileData';
...
const STORAGE_MEDIA_KEY = 'lysette_portfolio_media_items_v1';
const STORAGE_MEDIA_LIKES_KEY = 'lysette_portfolio_media_likes_v1';
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-5">
          <div>
            ...
            <p className="text-base sm:text-lg text-stone-600 mt-2 max-w-2xl leading-relaxed">
              Curated playlists for deep coding focus, inspiring UI/UX design talks, podcasts, and articles fueling my frontend journey.
            </p>
          </div>
