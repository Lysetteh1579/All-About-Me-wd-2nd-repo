...
import { Sparkles, Music, BookOpen, Camera, Compass } from 'lucide-react';
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  {item.category === 'hobbies' && <Camera className="w-4 h-4 text-amber-700" />}
                  {item.category === 'places' && <Compass className="w-4 h-4 text-amber-700" />}
                </div>
